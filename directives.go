...
func newDirectives(sdkConfig sdkConfiguration) *Directives {
	return &Directives{
...
func (s *Directives) ListDirectives(ctx context.Context) (*operations.ListDirectivesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/directives")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ListDirectivesResponseBody
...
func (s *Directives) CreateDirective(ctx context.Context, request *components.DirectiveNew) (*operations.CreateDirectiveResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.CreateDirectiveResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Directives) DirectiveDetails(ctx context.Context, directiveID string) (*operations.DirectiveDetailsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.DirectiveDetailsRequest{
		DirectiveID: directiveID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/directives/{directiveId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.DirectiveDetailsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// Delete a directive
func (s *Directives) DeleteDirective(ctx context.Context, directiveID string) (*operations.DeleteDirectiveResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.DeleteDirectiveRequest{
		DirectiveID: directiveID,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.DeleteDirectiveResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
