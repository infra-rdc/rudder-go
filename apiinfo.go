...
func newAPIInfo(sdkConfig sdkConfiguration) *APIInfo {
	return &APIInfo{
...
func (s *APIInfo) APIGeneralInformations(ctx context.Context) (*operations.APIGeneralInformationsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.APIGeneralInformationsResponseBody
...
func (s *APIInfo) APIInformations(ctx context.Context, endpointName string) (*operations.APIInformationsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.APIInformationsRequest{
		EndpointName: endpointName,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/info/details/{endpointName}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.APIInformationsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *APIInfo) APISubInformations(ctx context.Context, sectionID string) (*operations.APISubInformationsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.APISubInformationsRequest{
		SectionID: sectionID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/info/{sectionId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.APISubInformationsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
