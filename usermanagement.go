...
func newUserManagement(sdkConfig sdkConfiguration) *UserManagement {
...
// AddUser - Add user
// Add a new user
func (s *UserManagement) AddUser(ctx context.Context, request components.Users) (*operations.AddUserResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/usermanagement")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.AddUserResponseBody
...
func (s *UserManagement) GetRole(ctx context.Context) (*operations.GetRoleResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/usermanagement/roles")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *UserManagement) UpdateUser(ctx context.Context, username string, users components.Users) (*operations.UpdateUserResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/usermanagement/update/{username}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "Users", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *UserManagement) GetUserInfo(ctx context.Context) (*operations.GetUserInfoResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/usermanagement/users")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *UserManagement) ReloadUserConf(ctx context.Context) (*operations.ReloadUserConfResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/usermanagement/users/reload")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ReloadUserConfResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *UserManagement) DeleteUser(ctx context.Context, username string) (*operations.DeleteUserResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/usermanagement/{username}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
