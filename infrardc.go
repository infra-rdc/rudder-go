...
// InfraRdc - Rudder API: Download OpenAPI specification: [openapi.yml](openapi.yml)
//
...
type InfraRdc struct {
	...
	SystemUpdateCampaigns *SystemUpdateCampaigns
...
type SDKOption func(*InfraRdc)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *InfraRdc) {
...
func WithSecurity(apiTokens string) SDKOption {
	return func(sdk *InfraRdc) {
		security := components.Security{APITokens: apiTokens}
...
func New(opts ...SDKOption) *InfraRdc {
	sdk := &InfraRdc{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			OpenAPIDocVersion: "18",
			SDKVersion:        "0.0.1",
			GenVersion:        "2.335.5",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.335.5 18 github.com/infra-rdc/rudder-go",
			Hooks:             hooks.New(),
		},
	}
	...
	sdk.ChangeRequests = newChangeRequests(sdk.sdkConfiguration)

	sdk.Archives = newArchives(sdk.sdkConfiguration)

	sdk.Campaigns = newCampaigns(sdk.sdkConfiguration)

	sdk.Compliance = newCompliance(sdk.sdkConfiguration)

	sdk.Cve = newCve(sdk.sdkConfiguration)

	sdk.DataSources = newDataSources(sdk.sdkConfiguration)

	sdk.Directives = newDirectives(sdk.sdkConfiguration)

	sdk.Groups = newGroups(sdk.sdkConfiguration)

	sdk.APIInfo = newAPIInfo(sdk.sdkConfiguration)

	sdk.Inventories = newInventories(sdk.sdkConfiguration)

	sdk.Techniques = newTechniques(sdk.sdkConfiguration)

	sdk.Nodes = newNodes(sdk.sdkConfiguration)

	sdk.OpenSCAP = newOpenSCAP(sdk.sdkConfiguration)
	...
	sdk.ScaleOutRelay = newScaleOutRelay(sdk.sdkConfiguration)

	sdk.SecretManagement = newSecretManagement(sdk.sdkConfiguration)
	...
	sdk.SystemUpdateCampaigns = newSystemUpdateCampaigns(sdk.sdkConfiguration)

	sdk.UserManagement = newUserManagement(sdk.sdkConfiguration)
