...
func (s *Parameters) ListParameters(ctx context.Context) (*operations.ListParametersResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/parameters")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ListParametersResponseBody
...
func (s *Parameters) ParameterDetails(ctx context.Context, parameterID string) (*operations.ParameterDetailsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.ParameterDetailsRequest{
		ParameterID: parameterID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/parameters/{parameterId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ParameterDetailsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Parameters) UpdateParameter(ctx context.Context, parameterID string) (*operations.UpdateParameterResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.UpdateParameterRequest{
		ParameterID: parameterID,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.UpdateParameterResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Parameters) DeleteParameter(ctx context.Context, parameterID string) (*operations.DeleteParameterResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.DeleteParameterRequest{
		ParameterID: parameterID,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.DeleteParameterResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 500:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out sdkerrors.DeleteParameterResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
