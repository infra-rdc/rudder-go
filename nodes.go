...
func (s *Nodes) ListAcceptedNodes(ctx context.Context, request operations.ListAcceptedNodesRequest) (*operations.ListAcceptedNodesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ListAcceptedNodesResponseBody
...
func (s *Nodes) CreateNodes(ctx context.Context, request []components.NodeAdd) (*operations.CreateNodesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.CreateNodesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) ApplyPolicyAllNodes(ctx context.Context) (*operations.ApplyPolicyAllNodesResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/nodes/applyPolicy")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ApplyPolicyAllNodesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) ListPendingNodes(ctx context.Context, request operations.ListPendingNodesRequest) (*operations.ListPendingNodesResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/nodes/pending")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ListPendingNodesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) ChangePendingNodeStatus(ctx context.Context, nodeID string, requestBody *operations.ChangePendingNodeStatusRequestBody) (*operations.ChangePendingNodeStatusResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.ChangePendingNodeStatusRequest{
		NodeID:      nodeID,
		RequestBody: requestBody,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/nodes/pending/{nodeId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.ChangePendingNodeStatusResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) GetNodesStatus(ctx context.Context, ids string) (*operations.GetNodesStatusResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.GetNodesStatusRequest{
		Ids: ids,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/nodes/status")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.GetNodesStatusResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) NodeDetails(ctx context.Context, nodeID string, include *string) (*operations.NodeDetailsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.NodeDetailsRequest{
		NodeID:  nodeID,
		Include: include,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/nodes/{nodeId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.NodeDetailsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) UpdateNode(ctx context.Context, nodeID string, nodeSettings *components.NodeSettings) (*operations.UpdateNodeResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.UpdateNodeRequest{
		NodeID:       nodeID,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "NodeSettings", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.UpdateNodeResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) DeleteNode(ctx context.Context, nodeID string, mode *components.NodeDeleteMode) (*operations.DeleteNodeResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.DeleteNodeResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Nodes) ApplyPolicy(ctx context.Context, nodeID string) (*operations.ApplyPolicyResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.ApplyPolicyRequest{
		NodeID: nodeID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/nodes/{nodeId}/applyPolicy", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ApplyPolicyResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Nodes) NodeInheritedProperties(ctx context.Context, nodeID string) (*operations.NodeInheritedPropertiesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	request := operations.NodeInheritedPropertiesRequest{
		NodeID: nodeID,
	}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/nodes/{nodeId}/inheritedProperties", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.NodeInheritedPropertiesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
