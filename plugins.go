...
func (s *Plugins) PluginSettings(ctx context.Context) (*operations.PluginSettingsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/plugins/settings")
	if err != nil {
	...
	res := &operations.PluginSettingsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.PluginSettingsResponseBody
...
func (s *Plugins) UpdateSettings(ctx context.Context) (*operations.UpdateSettingsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.UpdateSettingsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
